        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="床位数" prop="Capacity">
              <el-input-number v-model="form.Capacity" :min="1" :max="50" placeholder="请输入床位数" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="已占用" prop="Occupied">
              <el-input-number v-model="form.Occupied" :min="0" :max="form.Capacity || 50" placeholder="请输入已占用床位数" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="楼层" prop="Floor">
              <el-input-number v-model="form.Floor" :min="1" :max="50" placeholder="请输入楼层" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所在楼" prop="Building">
              <el-input v-model="form.Building" placeholder="请输入所在楼" />
            </el-form-item>
          </el-col>
        </el-row>
...
watch(() => form.Capacity, (newVal) => {
  if (form.Occupied > newVal) {
    form.Occupied = newVal
  }
})
...
const rules = reactive({
  ...
  Building: [{ required: true, message: '请输入所在楼', trigger: 'blur' }]
})
